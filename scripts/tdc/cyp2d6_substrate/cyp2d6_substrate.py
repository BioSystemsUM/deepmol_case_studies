...
def run():
    init_time = time.time()
    group = get_benchmark_group['CYP2D6_Substrate_CarbonMangels']
    ...
    pipeline_name = 'cyp2d6_substrate'
    storage = f'sqlite:///{pipeline_name}.db'
    general_tdc_pipeline(pipeline_name=pipeline_name, group=group, tdc_dataset_name='CYP2D6_Substrate_CarbonMangels',
                         data_sample=data, seed=665544, optimizer='tpe', storage=storage,
