...
def run():
    ...
    # group = get_benchmark_group['AMES']
    ...
    general_tdc_pipeline(pipeline_name=pipeline_name, group=group, tdc_dataset_name='AMES',
                         data_sample=data, seed=12345, optimizer='tpe', storage=storage, metric=roc_auc_score,
