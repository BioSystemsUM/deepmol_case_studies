...
def run():
    init_time = time.time()
    group = get_benchmark_group['Lipophilicity_AstraZeneca']
    ...
    pipeline_name = 'lipophilicity'
    storage = f'sqlite:///{pipeline_name}.db'
    general_tdc_pipeline(pipeline_name=pipeline_name, group=group, tdc_dataset_name='Lipophilicity_AstraZeneca',
