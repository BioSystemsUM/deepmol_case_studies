...
def run():
    init_time = time.time()
    group = get_benchmark_group['PPBR_AZ']
    ...
    general_tdc_pipeline(pipeline_name=pipeline_name, group=group, tdc_dataset_name='PPBR_AZ',
                         data_sample=data, seed=123456, optimizer='tpe', storage=storage, metric=mean_absolute_error,
