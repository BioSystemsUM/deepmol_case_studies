...
def run():
    ...
    metric = Metric(average_precision_score)
    ...
    pipeline.optimize(train_dataset = train_dataset, test_dataset=validation_dataset, objective_steps=steps, n_trials=50, save_top_n=5,
...
def test_best_pipeline():
    ...
    pipeline = VotingPipeline.load("cyp2d6/voting_pipeline")
